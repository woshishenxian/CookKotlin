...
import com.vincee.app.cookkotlin.about.AboutActivity
import com.vincee.app.cookkotlin.adapter.MainComicGridAdapter
import com.vincee.app.cookkotlin.recent.RecentComicActivity
import com.vincee.app.model.Comic
import com.vincee.app.model.ComicData
import com.vincee.app.model.ComicType
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.nav_wxnews -> {
                ARouter.getInstance().build(RouterPath.News.PATH).navigation()
            }
            R.id.nav_livewall -> {
                ARouter.getInstance().build(RouterPath.WallPager.PATH_WALL_PAPER).navigation()
            }
            R.id.nav_male -> {
