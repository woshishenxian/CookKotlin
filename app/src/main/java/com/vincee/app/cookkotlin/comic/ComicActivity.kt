package com.vincee.app.cookkotlin.comic
...
import com.vincee.app.cookkotlin.comic.adapter.ComicAdapter
import com.vincee.app.cookkotlin.comic.adapter.OnItemClickCallBack
import com.vincee.app.cookkotlin.toast
...
class ComicActivity : BaseActivity() {
    ...
    private var snapHelper: SnapHelper = com.vincee.app.utils.OmgSnapHelper()
        ...
        mRecyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (layoutManager.findFirstCompletelyVisibleItemPosition() == 0) {
                    showNavigation()
                } else if (layoutManager.findLastCompletelyVisibleItemPosition() == (recyclerView.adapter?.itemCount  ?: 0)  - 1) {
                    showNavigation()
                } else {
                    hideNavigation()
                }
    ...
    private fun addRecentComic(comicData: ComicData) {
        val recentComic = com.vincee.app.db.model.RecentComic()
